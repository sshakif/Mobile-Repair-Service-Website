...
<html lang="en-US">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="56x56"
      href="assets/images/Brand logo & Icon/SVG/repairs.svg"
    />
    <!-- bootstrap CSS -->
    <link
      rel="stylesheet"
  ...
  <!--==================================================-->
          ...
          <div class="col-lg-6">
            <div class="header-info">
              <ul>
                ...
                <li><i class="bi bi-envelope"></i>NPRA.feedback@gmail.com </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="top-header-social-icon">
              <ul>
                ...
                <li>
                  <a href="https://api.whatsapp.com/send/?phone=%2B61410300544" target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <!--==================================================-->
    <!-- Start NPRA Website Header Area Style One-->
    <!--==================================================-->
        ...
        <div class="row align-items-center">
          <div class="col-lg-3">
            <div class="header-logo">
              <a href="index.php"
                ><img
                  src="assets/images/logo black green.svg"
                  alt="logo"
                  style="width: 100px"
              /></a>
            </div>
          ...
          <div class="col-lg-9">
            <div class="header-menu">
              ...
              <div class="header-button">
                <a href="store.php">Find A Store</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <!--==================================================-->
    <!-- End NPRA Website Header Area Style One-->
    <!--==================================================-->
